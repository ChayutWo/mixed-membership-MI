...
---
title: "ANES dataset model with MMM with data MCAR 15% - fix label switching"
output:
...
for (trial in 1:Mon) {
  ...
  # Step 6: Update x_ij: impute missing values with posterior predictive probabilities 
  for (j in 1:p) {
...
save(BETA, PHI, X, X_SAMPLE, X_POST, Z, file = "./samples_Sort_Beta/post_samples_sort_beta_mcar15.RData")
```
