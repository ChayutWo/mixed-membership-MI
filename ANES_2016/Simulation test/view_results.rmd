...
group = 1 # change this value
var_list = c('V162123', 'V162209', 'V162214', 'V162233', 'V162269')

# plotting section
par(mfrow=c(3,2), oma = c(5.5,4.5,5,0.2) + 0.1, mar = c(0.75,0.25,1.25,1.25) + 0.5)
