...
---
title: "ANES dataset model with MMM with data MCAR 30% - fix label switching + merge levels of responses + cut out some variables + long simulation"
output:
...
save(BETA, PHI, X, X_miss, X_SAMPLE, X_POST, Z, 
     file = "./samples_Sort_Beta/post_samples_mergedlv_sort_beta_long_MCAR30.RData")
```
