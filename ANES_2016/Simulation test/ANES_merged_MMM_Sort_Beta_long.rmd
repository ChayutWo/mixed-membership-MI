...
---
title: "ANES dataset model with MMM without missing values - fix label switching + merge levels of responses + cut out some variables + long simulation"
output:
...
save(BETA, PHI, X, X_POST, Z, 
     file = "./samples_Sort_Beta/post_samples_mergedlv_sort_beta_long.RData")
```
