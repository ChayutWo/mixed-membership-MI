...
---
title: "ANES dataset model with MMM without missing values - fix label switching + merge levels of responses"
output:
...
for (k in 1:K) {
  ...
  matplot(1:dim(phi_df)[1], phi_df, 
          ...
          col = c('black', 'green', 'blue'), lty = 1:3, lwd = 1, cex.main = 0.75)
  legend('right', legend = colnames(phi_df), col = c('black', 'green', 'blue'), lty = 1:3, lwd = 1)
}
```
...
save(BETA, PHI, X, X_POST, Z, file = "./samples_Sort_Beta/post_samples_mergedlv_sort_beta.RData")
```
