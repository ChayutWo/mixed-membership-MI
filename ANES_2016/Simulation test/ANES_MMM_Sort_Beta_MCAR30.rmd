...
---
title: "ANES dataset model with MMM with data MCAR 30% - fix label switching"
output:
...
save(BETA, PHI, X, X_SAMPLE, X_POST, Z, file = "./samples_Sort_Beta/post_samples_sort_beta_mcar30.RData")
```
