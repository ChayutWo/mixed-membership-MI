...
for (trial in 1:Mon) {
  ...
  save_time = save_time + (Sys.time() - start)
...
total_time = z_time + nik_time + phi_time + aux_time + beta_time + pi_time + 
  gamma_time + alpha_time + save_time
data = as.numeric(c(z_time, nik_time, phi_time, aux_time, beta_time, pi_time, 
                    gamma_time, alpha_time, save_time))/as.numeric(total_time)
names(data) = c('z', 'nik', 'phi', 'aux', 'beta', 'pi', 'gamma', 'alpha', 'save')
